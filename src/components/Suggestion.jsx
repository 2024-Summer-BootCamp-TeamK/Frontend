...
export const Suggestion = () => {
  ...
  // 각 텍스트 파일의 섹션들
  const text1Sections = ["Text1 Section 1", "Text1 Section 2", "Text1 Section 3"];
  const text2Sections = ["Text2 Section 1", "Text2 Section 2", "Text2 Section 3"];
  ...
  return (
    <Container>
      ...
      <ScrollButton onClick={() => scrollToSection(currentSection - 1)} disabled={currentSection === 0}>
        {"<"}
      </ScrollButton>
      ...
      <ScrollButton onClick={() => scrollToSection(currentSection + 1)} disabled={currentSection === sections.length - 1}>
        {">"}
      </ScrollButton>
      <ProgressContainer>
